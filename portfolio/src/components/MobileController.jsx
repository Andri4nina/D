...
const MobileControls = () => {
    ...
    return (
        <div className="block md:hidden fixed inset-0 pointer-events-none z-50">
            ...
            <div ref={joystickRef} className="pointer-events-auto absolute bottom-5 left-8 w-28 h-28">
            ...
            <div className="pointer-events-auto absolute bottom-8 right-8 flex flex-col gap-5">
                <button
                    ...
                    onMouseDown={() => simulateKey(' ', 'keydown')}
                    onMouseUp={() => simulateKey(' ', 'keyup')}
                    onMouseLeave={() => simulateKey(' ', 'keyup')}
                ...
                <button
                    onTouchStart={() => simulateKey('shift', 'keydown')}
                    onTouchEnd={() => simulateKey('shift', 'keyup')}
                    onMouseDown={() => simulateKey('shift', 'keydown')}
                    onMouseUp={() => simulateKey('shift', 'keyup')}
                    onMouseLeave={() => simulateKey('shift', 'keyup')}
                    className="w-16 h-16 rounded-full flex items-center justify-center text-white shadow-lg transition-all relative overflow-hidden group"
                    style={{
                        background: 'radial-gradient(circle at 65% 35%, rgba(59,130,246,0.9) 0%, rgba(37,99,235,0.85) 70%)',
                        backdropFilter: 'blur(4px)',
