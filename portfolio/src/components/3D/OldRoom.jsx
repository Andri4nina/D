...
import { Point, useGLTF, useTexture } from '@react-three/drei'


export function OldRoom({ isNight, ...props }) {
  const { nodes, materials } = useGLTF('/object3d/OldRoom.glb')
  const screenTexture = useTexture("/textures/Portfolio ancien screen.png");

  return (
    <group {...props} dispose={null} position={[0, .5, 0]} scale={.5}>
...
useGLTF.preload('/object3d/OldRoom.glb')